...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://ashleykualii.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://ashleykualii.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
  ...
  handleSubmit(event) {
    axios({
      ...
      .then((response) => {
        ...
        if (this.props.editMode) {
          //UPdate blog detail
          this.props.handleUpdateFromSubmission(response.data.portfolio_blog);
        } else {
